      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 min-h-screen">
          ...
          >
            ...
            {/* Paragraph */}
            <motion.p
              className="text-base sm:text-lg md:text-lg lg:text-xl xl:text-2xl text-gray-700 leading-relaxed font-[300] max-w-md lg:max-w-lg mt-25 sm:mt-6 md:mt-16 lg:mt-32 xl:mt-40 tracking-[0.045em]"
              variants={itemFadeUp}
            >
              Discover a range of innovative software projects designed to
              solve real-world challenges with precision
            </motion.p>
          </motion.div>
